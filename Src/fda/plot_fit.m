function plot_fit(y, argvals, fdobj, residual, sortwrd, rng, index)
%PLOT_FIT plots discrete data along with a functional data object for 
...
%  This function is identical to function plotfit_fd.
%  Arguments:
...
%  If PLOT_FIT is modified, function PLOTFIT_FD should also changed.
