function plot_beta(betaestcell, betastderrcell, argvals)
%  PLOT_BETA plots a functional parameter along with confidence
%  limits.  This function is identical to function plotbeta.
%  Arguments:
...
%  If this function is modified, function PLOT_BETA should be also changed.
